      ...
      <div className="App">
        ...
        >
          ...
          <Grid.Column style={{ maxWidth: 450, marginTop: '10em', marginLeft: '20px', marginRight: '20px' }}>
            <Header as='h1' size='huge' textAlign='center' onClick={() => this.changeView('main')}>
              Crowd Vote
            </Header>
            ...
            <Transition.Group duration={{ hide: 0, show: 600 }} animation={'fly left'}>
              {this.state.view === 'create' && <Segment className='segment' color='teal' raised><Create view={this.changeView} /></Segment>}
            </Transition.Group>
